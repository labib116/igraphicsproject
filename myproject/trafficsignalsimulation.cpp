...
int lcarindex= 0,leftcar_x=5,leftcar_y=600,rightcar_x=1660,rightcar_y=600-95,upcar_x=710,upcar_y=5,downcar_x=800,downcar_y=screenheight;
int leftcounter=0;
...
void leftcarshow(){
	...
	if(leftcar_x>=150-100){
		iShowBMP2(leftcar_x-150-100,leftcar_y-40,left_vehicle[lcarindex],0);
		//iShowBMP2(leftcar_x-155,leftcar_y-44,left_vehicle[lcarindex+1],0);
		iShowBMP2(leftcar_x-150-100,leftcar_y+20,left_vehicle[lcarindex],0);
	}
    if(leftcar_x>=320-100){
		iShowBMP2(leftcar_x-320-100,leftcar_y,left_vehicle[lcarindex+1],0);
		iShowBMP2(leftcar_x-320-100,leftcar_y-44,left_vehicle[lcarindex],0);
	}
	if(leftcar_x>=580-100){
		iShowBMP2(leftcar_x-550-100,leftcar_y,left_vehicle[lcarindex+2],0);
		iShowBMP2(leftcar_x-550-100,leftcar_y-44,left_vehicle[lcarindex+1],0);
	}
	if(leftcar_x>=800-100){
		iShowBMP2(leftcar_x-700-100,leftcar_y,left_vehicle[lcarindex+3],0);
		iShowBMP2(leftcar_x-720-100,leftcar_y-44,left_vehicle[lcarindex+2],0);
	}
	if(leftcar_x>=1050-100){
		iShowBMP2(leftcar_x-1030,leftcar_y+15,left_vehicle[lcarindex+2],0);
...
void downcarshow(){
    iShowBMP2(downcar_x,downcar_y,downvhicle[0],0);
	iShowBMP2(downcar_x+40,downcar_y,downvhicle[1],0);
...
int special_x1[]={0,0,0,0},special_y1[]={650,650,650},specialindex[]={0,0,0,0};
int special_x2=0,special_y2=650,specialindex1=0;
int count_2=0;
void specialleftcarshow_1(){
    iShowBMP2(special_x1[0],special_y1[0],carlefttoup[specialindex[0]],0);
    if(count_2>=20){
        iShowBMP2(special_x1[1],special_y1[1],carlefttoup[specialindex[1]],0);
    }
    if(count_2>=35){
        iShowBMP2(special_x1[2],special_y1[2],bikelefttoup[specialindex[2]],0);
    }
    /*else{
        if(special_x2>500){
...
int special_x3[]={1050,1050,1050}, special_y3[]={1096,1096,1096} ,specialindex2[]={0,0,0};
int special_x4=1050, special_y4=1096, specialindex3=0;

void specialdowncarshow_1(){
    iShowBMP2(special_x3[0], special_y3[0], bikedowntoright[specialindex2[0]], 0);
    if (count_2>=20) {
        iShowBMP2(special_x3[1], special_y3[1], cardowntoright[specialindex2[1]], 0);
    }
    if(count_2>=35){
         iShowBMP2(special_x3[2], special_y3[2], bikedowntoright[specialindex2[2]], 0);
    }
}
int special_x5[]={650,650,650},special_y5[]={0,0,0},specialindex4[]={0,0,0};
void specialuptoleftcarshow(){
    iShowBMP2(special_x5[0],special_y5[0],caruptoleft[specialindex4[0]],0);
    if(count_2>=20){
        iShowBMP2(special_x5[1],special_y5[1],caruptoleft[specialindex4[1]],0);
    }
    if(count_2>=35){
        iShowBMP2(special_x5[2],special_y5[2],caruptoleft[specialindex4[2]],0);
    }
}
int special_x6[]={1550,1550,1550},special_y6[]={230,230,230},specialindex5[]={0,0,0};
void specialrighttodowncarshow(){
    iShowBMP2(special_x6[0],special_y6[0],carrighttodown[specialindex5[0]],0);
    if(count_2>=20){
        iShowBMP2(special_x6[1],special_y6[1],bikerighttodown[specialindex5[1]],0);
    }
    if(count_2>=35){
        iShowBMP2(special_x6[2],special_y6[2],bikerighttodown[specialindex5[2]],0);
    }
}
...
void upcarmove_2(int *upcar_y_2, bool leftdown_2) {
    if (leftdown_2) 
        *upcar_y_2 += 10 + rand()%5;
    else {
        if (*upcar_y_2 > 140) 
...
void specialleftcar1move(int *p,int *q,int *i) {
...
void specialcarmovedown_1(int *p,int *q,int *i){
       if(*q>720){
        *q-=20;
        if(*q<780 && *q>720){
            if(*i<5)
...
void specialcarmovedwontoleft(int *p,int *q,int *i){
    if(*q<220){
        *q+=20;
        if(*q>160 && *q<220){
            if(*i<5){
...
void specialcarmoverighttodown(int *p,int *q,int *i){
    if(*p>1030){
        *p-=15;
        if(*p<=1150 && *p>1030){
            if(*i<5){
...
void roundaboutrighttoleftcarmovement(int *p,int *q,int *i){
    ...
    if(screencount==2){
        ...
        specialleftcar1move(&special_x1[0],&special_y1[0],&specialindex[0]);
        if(count_2>=20){
            specialleftcar1move(&special_x1[1],&special_y1[1],&specialindex[1]);
        }
        if(count_2>=35){
             specialleftcar1move(&special_x1[2],&special_y1[2],&specialindex[2]);
        }
        /*else{
        if(special_x2>500){
    ...
    specialcarmovedown_1(&special_x3[0],&special_y3[0],&specialindex2[0]);
    if(count_2>=20){
       specialcarmovedown_1(&special_x3[1],&special_y3[1],&specialindex2[1]);
    }
    if(count_2>=35){
        specialcarmovedown_1(&special_x3[2],&special_y3[2],&specialindex2[2]);
    }
    specialcarmovedwontoleft(&special_x5[0],&special_y5[0],&specialindex4[0]);
    if(count_2>=20){
        specialcarmovedwontoleft(&special_x5[1],&special_y5[1],&specialindex4[1]);
    }
    if(count_2>=35){
        specialcarmovedwontoleft(&special_x5[2],&special_y5[2],&specialindex4[2]);
    }
    specialcarmoverighttodown(&special_x6[0],&special_y6[0],&specialindex5[0]);
    if(count_2>=20){
        specialcarmoverighttodown(&special_x6[1],&special_y6[1],&specialindex5[1]);
    }
    if(count_2>=35){
       specialcarmoverighttodown(&special_x6[2],&special_y6[2],&specialindex5[2]);
    }
...
int main() {
	...
	iSetTimer(10, change);
	iInitialize(screenwidth, screenheight, "traffic signal simulator");
	return 0;
}
